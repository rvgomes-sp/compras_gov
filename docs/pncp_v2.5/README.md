# Documentação PNCP v. 2.5

Esta pasta contém somente fontes locais usadas na construção e auditoria do GSB Monitor V2.5.

## Cobertura

- `manual/manual_integracao_pncp_v2.5.html`: Manual de Integração do PNCP v. 2.5 completo.
- `openapi/api-docs.json`: especificação OpenAPI integral disponível no projeto, contendo o inventário completo de rotas, métodos e esquemas.
- `endpoints/compras/`: páginas operacionais das consultas de contratação, itens, resultados, documentos e histórico usadas no EVT007.
